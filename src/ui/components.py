"""Reusable UI components for the WC 2026 Streamlit app (M3 via style.css)."""
...
SQUAD_BADGE = {"final": ("Final", "badge-final"), "preliminary": ("Preliminary", "badge-prelim")}
...
def render_sidebar_nav() -> str:
    ...
    st.sidebar.markdown("---")
    st.sidebar.caption("Baseline ML model · ELO · FIFA · form")
    return choice
...
def render_hero() -> None:
    st.markdown(
        ...
        <div class="hero">
          ...
          <p>48 teams · 12 groups · Monte Carlo knockout · Match outcomes powered by your trained model.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
